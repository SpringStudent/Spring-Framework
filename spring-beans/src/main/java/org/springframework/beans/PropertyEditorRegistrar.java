 ...
 *
 * 使用{@link org.springframework.beans.PropertyEditorRegistry property editor registry}
 * 注册{@link java.beans.PropertyEditor property editors} 的策略接口
 *
 * 使用{@link org.springframework.beans.PropertyEditorRegistry属性编辑器注册表}
 * 注册自定义{@link java.beans.PropertyEditor属性编辑器}的策略的接口。
 *
...
public interface PropertyEditorRegistrar {
	 ...
	 * 使用给定的{@code PropertyEditorRegistry}
	 * 注册自定义{@link java.beans.PropertyEditor PropertyEditors}
