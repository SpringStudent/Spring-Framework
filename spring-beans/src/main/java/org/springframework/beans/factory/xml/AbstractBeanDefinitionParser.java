...
public abstract class AbstractBeanDefinitionParser implements BeanDefinitionParser {
	 ...
	 * 钩子方法，在主要解析为{@link BeanComponentDefinition}之前并且{@link BeanComponentDefinition}
	 * 已经注册到   {@link org.springframework.beans.factory.support.BeanDefinitionRegistry}会被调用
	 * 派生类可以覆盖此方法，以提供在完成所有解析后要执行的任何自定义逻辑
	 */
	//TODO 扩展点
