...
public class ResolvableType implements Serializable {
	 ...
	 *
	 * 为指定的{@link Type}返回{@link ResolvableType}。
	 * 注意：生成的{@link ResolvableType}可能不是{@link Serializable}
	 ...
	 * {@link VariableResolver}.
	 *
	 * 为给定{@link VariableResolver}支持的指定{@link Type}返回{@link ResolvableType}
	 *
	 * @param type the source type or {@code null}
	...
	static ResolvableType forType(Type type, TypeProvider typeProvider, VariableResolver variableResolver) {
		...
		//对于简单的类引用，立即构建包装器 - 不需要昂贵的解决方案，因此不值得缓存......
