...
/**
 * {@link org.springframework.aop.aspectj.AspectInstanceFactory}的子接口，返回与AspectJ注释类关联的{@link AspectMetadata}
 *
 ...
 *
 * 理想情况下，AspectInstanceFactory本身会包含此方法，
 * 但由于AspectMetadata仅使用Java-5 {@link org.aspectj.lang.reflect.AjType}，因此我们需要拆分此子接口。
 *
 * @author Rod Johnson
 * @since 2.0
 * @see AspectMetadata
