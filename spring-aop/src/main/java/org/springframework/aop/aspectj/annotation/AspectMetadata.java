...
public class AspectMetadata implements Serializable {
	...
	/**
	 * aspect class单独存储用于在反序列化时解析AjType
	 */
	 ...
	 *
	 * AspectJ反射信息（AspectJ 5 / Java 5）
	 * 不需要序列化，可以通过aspectClass去反解析
	 */
	private transient AjType<?> ajType;

	/**
	 * spring AOP pointcut 与apsect per clause的关联关系
	 * 在单例模式情况下这个值将会是Pointcut.TRUE,否则AspectJExpressionPointcut
	 */
	private final Pointcut perClausePointcut;


	/**
	 * 为给定的切面类创建一个新的AspectMetada实例
